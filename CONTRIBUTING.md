# Contributing to Emporia Vue MQTT Bridge
...
EMPORIA_USERNAME=x EMPORIA_PASSWORD=x MQTT_PASSWORD=x python -c "import main"
EMPORIA_USERNAME=x EMPORIA_PASSWORD=x MQTT_PASSWORD=x python -m pytest -q
```
...
- [`ghcr.io/geoffmyers/emporia-vue-mqtt-bridge`](https://github.com/geoffmyers/emporia-vue-mqtt-bridge/pkgs/container/emporia-vue-mqtt-bridge): `Dockerfile`, with the application code added
